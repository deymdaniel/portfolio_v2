...
const Footer = ({ personalInfo, social }) => {
  ...
  return (
    <footer
      className={`${config.colors.primary} ${config.colors.border} border-t py-12 px-6`}
    >
      <div className='max-w-6xl mx-auto'>
        <div className='flex flex-col md:flex-row justify-between items-center'>
          <div className='mb-8 md:mb-0'>
            <h3
              className={`${config.colors.textPrimary} text-2xl font-bold mb-2`}
            >
              {name}
            </h3>
          ...
          <div className='flex flex-col items-center md:items-end'>
            ...
            <p className={`${config.colors.textMuted} text-sm`}>
